...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    'knife_filter': {
        ...
        'knife_lookback_bars': 6,
        'knife_momentum_threshold': -0.25,
        'knife_single_bar_drop_pct': -1.10,
    },
    'scanner': {
        'enabled': True,
...
FIELDS = {
    ...
    'knife_filter.knife_lookback_bars': int,
    'knife_filter.knife_momentum_threshold': float,
    'knife_filter.knife_single_bar_drop_pct': float,
    'fuel.enabled': bool,
